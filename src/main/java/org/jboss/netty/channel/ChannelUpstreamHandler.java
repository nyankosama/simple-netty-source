...
/**
 * Handles or intercepts an upstream {@link org.jboss.netty.channel.event.ChannelEvent}, and sends a
 ...
 * void handleUpstream({@link ChannelHandlerContext} ctx, {@link org.jboss.netty.channel.event.ChannelEvent} e) throws Exception {
 *     ...
 *     ctx.sendUpstream(e);
 *     ...
 * }
 ...
 *     ...
 *     ctx.sendDownstream(new {@link org.jboss.netty.channel.event.DownstreamMessageEvent}(...));
 *     ...
 * }
 * </pre>
 *
 ...
 * <h3>Thread safety</h3>
 * <p>
 * {@link #handleUpstream(ChannelHandlerContext, org.jboss.netty.channel.event.ChannelEvent) handleUpstream}
